...
ActiveRecord::Schema.define(version: 2019_03_04_034816) do
  ...
  create_table "playlist_saves", force: :cascade do |t|
    t.integer "playlist_id", null: false
    t.integer "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["playlist_id"], name: "index_playlist_saves_on_playlist_id"
    t.index ["user_id"], name: "index_playlist_saves_on_user_id"
  end
