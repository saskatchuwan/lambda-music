...
#Albums
Album.destroy_all
album1 = Album.create(title: "The Year of Hibernation", artist_id: 1)

# album1.cover.attach(io: File.open('./app/assets/images/content/album_images/youth-lagoon-hiberation.jpg'), filename: 'youth-lagoon-hiberation.jpg')
